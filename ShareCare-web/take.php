...
<body>
	...
	<div id="contents">
			...
			<div class="sidebar">
				<div>
					...
					<ul>
						...
						<li>
                                                    <a href="http://healthlitmus.com/login.php">Test</a>
						</li>
					</ul>
				</div>
				<div>
     ...
     $q ="INSERT INTO taker(first_name,last_name,dob,email,city,area,contact,blood_group) VALUES ('$first_name','$last_name','$dob','$email','$city','$area','$contact','$blood_group')";
			...
			<div class="main">
				<h1>TAKE</h1>
                                <form action=donorlist.php method="post" role=form>
	...
	First Name: <input type="text" name="first_name" id="first_name" placeholder="first name"><br><br>
               ...
               Required Blood Group: <select name="blood_group" id="blood_group">
